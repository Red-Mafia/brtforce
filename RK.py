...
def login():
    ...
    print ('\033[34;1m|            |')
    print ('\033[31;1m|  RED------  |')
    print ('\033[34;1m| MAFIA|')
    print (' ')
    print ('\033[34;1mRED-MAFIA APA PASSWORD NY?')
    print ('       ')
    pasw = input('\033[34;1mRK : ')
    if pasw == y:
...
print ("\033[36;1m█▄█████▄█")
print ("\033[33;1m█▼▼▼▼▼")
print ("\033[32;1m█\033[32;1mAuthor : RED-MAFIA/RK")
print ("\033[32;1m█\033[32;1mWATSP    :   +923188214452")
print ("\033[33;1m█▲▲▲▲▲")
print ("\033[36;1m█████████")
print ("\033[36;1m██ ██")
print ('  ')
print ("Contoh watsp: +923188214452")
print ("       ")
